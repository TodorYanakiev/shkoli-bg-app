...
const LyceumEditPage = () => {
  ...
  const actionButtonClassName =
    'inline-flex items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-brand/40 hover:text-brand disabled:cursor-not-allowed disabled:text-slate-400'
    ...
    <section className="space-y-4">
      ...
      {!isValidId ? (
        ...
        <form
          ...
          className="w-full max-w-4xl space-y-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm"
