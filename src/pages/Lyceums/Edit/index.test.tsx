...
vi.mock("../hooks/useLyceumImages", () => ({
  ...
  lyceumImagesQueryKey: (id?: number) => ["lyceums", "images", id] as const,
}));
...
describe("LyceumEditPage", () => {
  ...
  it("submits updates and navigates after success", async () => {
    const mutateMock: UpdateLyceumMutationResult["mutate"] = (
      values,
      options,
    ) => {
      options?.onSuccess?.({
