...
export const AdminUsersPaginationControls = ({
  pagination,
  ...
  return (
    <div className="flex items-center justify-between gap-4">
      <button
        ...
        aria-label={t('pages.admin.users.pagination.previous')}
        title={t('pages.admin.users.pagination.previous')}
      >
        <svg
          viewBox="0 0 20 20"
          className="h-4 w-4"
      ...
      <span className="rounded-full border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-700 shadow-sm">
        {t('pages.admin.users.pagination.page', {
      ...
      <button
        ...
        className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white p-2 text-slate-600 shadow-sm transition hover:border-brand/40 hover:text-brand disabled:cursor-not-allowed disabled:opacity-40"
        aria-label={t('pages.admin.users.pagination.next')}
        title={t('pages.admin.users.pagination.next')}
      >
        <svg
          viewBox="0 0 20 20"
          className="h-4 w-4"
