...
type CourseEditImageUploadCardProps = {
  label: string
...
export const CourseEditImageUploadCard = ({
  label,
  role,
  image,
  error,
  ...
  onAltTextChange,
  t,
}: CourseEditImageUploadCardProps) => (
        ...
        <div className="flex-1 space-y-2">
          <label className="text-xs font-medium text-slate-600">
            ...
            <input
              ...
              placeholder={t('pages.shkoli.create.images.altTextPlaceholder')}
            />
          </label>
