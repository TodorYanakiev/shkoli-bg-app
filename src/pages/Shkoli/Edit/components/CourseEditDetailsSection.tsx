...
type CourseEditDetailsSectionProps = {
...
export const CourseEditDetailsSection = ({
  register,
  errors,
  isInLyceum,
  t,
}: CourseEditDetailsSectionProps) => (
    ...
    <div className="grid gap-4 md:grid-cols-2">
      <label className="text-sm font-medium text-slate-700">
        ...
        <input
          ...
          className={courseEditStyles.inputClassName(Boolean(errors.price))}
        />
        {errors.price ? (
