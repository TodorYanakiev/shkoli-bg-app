...
export const getCourseEditLoadError = (error: ApiError | null) =>
  toAppError(error, 'pages.shkoli.edit.loadFailed')

export const getCourseUpdateError = (error: ApiError | null) =>
  toAppError(error, 'errors.courses.updateFailed')

export const getCourseImagesError = (error: ApiError | null) =>
  toAppError(error, 'pages.shkoli.edit.images.error')
