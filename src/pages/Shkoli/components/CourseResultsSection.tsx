...
const CourseResultsSection = ({
  ...
  const canLoadMore = !isLoading && !error && page < totalPages
      ...
      {canLoadMore ? (
        <div className="flex justify-center">
          <button
            ...
            className="rounded-full bg-emerald-800 px-10 py-2 text-sm font-semibold text-white shadow-lg shadow-emerald-900/20 transition hover:bg-emerald-900"
          >
            {isFetching
              ? t('pages.shkoli.list.pagination.moreLoading')
              : t('pages.shkoli.list.pagination.more')}
          </button>
        </div>
      ) : null}
    </section>
