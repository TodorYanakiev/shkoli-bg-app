...
import { normalizeOptionalText } from '../services/courseCreateFormUtils'
import {
  buildCourseImageS3Key,
  createImageId,
  loadImageDimensions,
} from '../services/courseCreateImageUtils'
import { isApiError } from '../services/courseCreateErrors'
import type { ImageUploadResult, PendingCourseImage } from '../types'

type UseCourseCreateImagesOptions = {
  t: TFunction
}

export const useCourseCreateImages = ({
  t,
