...
const AuthLayout = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 text-slate-900">
      <TopNav />
      <main className="relative w-full flex-1 overflow-hidden px-4 pb-8 pt-[calc(var(--topnav-height,76px)+2rem)] sm:px-6 sm:pb-10 sm:pt-[calc(var(--topnav-height,76px)+2.5rem)] lg:px-12">
